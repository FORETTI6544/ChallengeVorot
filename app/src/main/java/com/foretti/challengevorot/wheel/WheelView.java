...
public class WheelView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < genres.size(); i++) {
            ...
            paint.setColor(ContextCompat.getColor(getContext(), R.color.textPrimary));
    ...
    public void spinToGenre(String targetGenre) {
        spinning = true;
        ...
        int targetIndex = -1;
        for (int i = 0; i < genres.size(); i++) {
            if (genres.get(i).equals(targetGenre)) {
                targetIndex = i;
                break;
            }
        }
        ...
        float targetAngle = rotationAngle + extraAngle + anglePerItem * ((float) genres.size() - (float) targetIndex) - (90f + anglePerItem / 2);
        ...
        rotationAnimator.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationEnd(@NonNull Animator animator) {
                ...
                selectedGenre.setValue(targetGenre);
                spinning = false;
            }
